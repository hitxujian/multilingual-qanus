...
public class MLBaselineARHeuristic {
	...
	public DataItem execute(String[] l_BestSentence, String l_ExpectedAnswerType, DataItem a_QuestionItem, boolean a_Analysis, DataItem l_AnalysisResults, String l_QuestionTarget, QuestionSubType l_SubType, String l_QuestionText, String l_QuestionPOS, String l_Query, ScoreDoc[] l_RetrievedDocs, String l_QuestionID) 
	{
		...
		// -----
		DataItem response;
		response = switchCases( l_ExpectedAnswerType,  a_QuestionItem,  l_BestSentence,  a_Analysis,  l_AnalysisResults,  l_Answer,  l_OriginalAnswerString,  l_POSTaggedBestSentence,  l_QuestionTarget,  l_SubType,  l_QuestionText,  l_QuestionPOS,  l_RetrievedDocs,  l_Query);
